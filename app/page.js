  ...
  return (
    <>
      <div className="main flex">
        {/* Sidebar */}
        <div className={`fixed inset-0 z-50 md:static md:z-auto md:flex flex-col justify-between  items-center
           w-[100%] md:w-[25%] min-h-screen bg-[#f3f3f3] gap-8 p-4 transform ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-300 ease-in-out`}>
...
<div className="m-6">
          ...
          <div className="h-1 bg-[#f4f4f4]"></div>
